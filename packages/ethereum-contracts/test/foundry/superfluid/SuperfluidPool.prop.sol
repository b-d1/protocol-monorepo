...
import { GeneralDistributionAgreementV1 } from "../../../contracts/agreements/gda/GeneralDistributionAgreementV1.sol";
import { SuperfluidPool } from "../../../contracts/superfluid/SuperfluidPool.sol";
...
contract SuperfluidPoolProperties is SuperfluidPool, Test {
    ...
    function _helper_Assert_Wrapped_Particle(PoolIndexData memory poolIndexData, BasicParticle memory particle)
        internal
    {
        assertEq(
    ...
    function _helper_Assert_Wrapped_Particle(MemberData memory memberData, BasicParticle memory particle) internal {
        assertEq(
            FlowRate.unwrap(particle.flow_rate()),
