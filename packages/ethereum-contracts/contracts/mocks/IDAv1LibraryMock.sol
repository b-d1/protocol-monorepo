...
contract IDAv1LibraryMock {
    ...
    constructor(ISuperfluid host) {
        _idaLib =
            IDAv1Library.InitData(host, IInstantDistributionAgreementV1(address(host.getAgreementClass(_IDAV1_HASH))));
    }
    ...
    function calculateDistributionTest(ISuperfluidToken token, address publisher, uint32 indexId, uint256 amount)
        external
        view
    ...
    function getSubscriptionTest(ISuperfluidToken token, address publisher, uint32 indexId, address subscriber)
        external
        view
    ...
    function createIndexWithUserDataTest(ISuperfluidToken token, uint32 indexId, bytes memory userData) external {
        _idaLib.createIndex(token, indexId, userData);
    }

    function updateIndexValueTest(ISuperfluidToken token, uint32 indexId, uint128 indexValue) external {
    ...
    function distributeWithUserDataTest(ISuperfluidToken token, uint32 indexId, uint256 amount, bytes memory userData)
        external
    {
    ...
    function approveSubscriptionTest(ISuperfluidToken token, address publisher, uint32 indexId) external {
    ...
    function revokeSubscriptionTest(ISuperfluidToken token, address publisher, uint32 indexId) external {
    ...
    function updateSubscriptionUnitsTest(ISuperfluidToken token, uint32 indexId, address subscriber, uint128 units)
        external
    {
    ...
    function deleteSubscriptionTest(ISuperfluidToken token, address publisher, uint32 indexId, address subscriber)
        external
    {
    ...
    function claimTest(ISuperfluidToken token, address publisher, uint32 indexId, address subscriber) external {
...
contract IDAv1LibrarySuperAppMock is IDAv1LibraryMock, SuperAppBase {
    ...
    function _callbackTest(ISuperToken token, bytes memory ctx) internal returns (bytes memory) {
        ...
        if (functionIndex == uint8(FunctionIndex.CREATE_INDEX)) {
            ...
            return _idaLib.approveSubscriptionWithCtx(ctx, token, publisher, indexId, _MOCK_USER_DATA);
            ...
            return _idaLib.revokeSubscriptionWithCtx(ctx, token, publisher, indexId, _MOCK_USER_DATA);
            ...
            return _idaLib.updateSubscriptionUnitsWithCtx(ctx, token, indexId, subscriber, units, _MOCK_USER_DATA);
            ...
            return _idaLib.deleteSubscriptionWithCtx(ctx, token, publisher, indexId, subscriber, _MOCK_USER_DATA);
            ...
            return _idaLib.claimWithCtx(ctx, token, publisher, indexId, subscriber, _MOCK_USER_DATA);
        } else {
